...
class TABillListScreen extends GetWidget<TABillListController> {
  const TABillListScreen({Key? key}) : super(key: key);
      ...
      body: Padding(
        ...
        child: Column(
          children: [
            ...
            // CustomImageView(
            //   imagePath: ImageConstant.listDataNotFound,
            //   fit: BoxFit.fill,
            //   imageHeight: 343.h,
              ...
              child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  return GestureDetector(
                    onTap: () {
                      Get.toNamed(AppRoutes.viewTABill);
                    },
                    child: Padding(
