...
import 'controller/edit_coordinator_tours_per_view_controller.dart'; // ignore_for_file: must_be_immutable

class EditCoordinatorToursPerViewScreen
    extends GetWidget<EditCoordinatorToursPerViewController> {
  const EditCoordinatorToursPerViewScreen({Key? key})
      : super(
          key: key,
        );
